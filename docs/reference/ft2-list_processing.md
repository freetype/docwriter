...
A typeless pointer passed to <a href="../ft2-list_processing/#ft_list_iterate">FT_List_Iterate</a>. Can be used to point to the iteration's state.
</td></tr>
</table>
...
A typeless pointer passed to <a href="../ft2-list_processing/#ft_list_iterate">FT_List_Iterate</a>. It can be used to point to the iteration's state.
</td></tr>
</table>
